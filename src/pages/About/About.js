        ...
        <div className='about container mx-auto my-5' >
            ...
            <div className='row justify-content-center'>
                ...
                <div className="about-accordian col-sm-12 col-md-10 col-lg-6">
                    <h3 className='text-center mt-md-5' >Wills Eye Hospital</h3>
                    <p className='my-4'>Wills Eye Hospital has provided comprehensive ophthalmology care for patients since 1832. Our skilled physicians and staff are dedicated to improving and preserving sight locally, regionally, and globally, and treat more than 350,000 patients a year.Wills Eye has ranked consistently among the best ophthalmology hospitals in the U.S. Our team comprises some of the world's top eye doctors and has more top eye surgeons than any hospital in the United States. </p>
                    <Accordion defaultActiveKey="0">
                        <Accordion.Item eventKey="0">
                            <Accordion.Header ><span className='fw-bold'>Why Wills Eye Hospital?</span></Accordion.Header>
                            <Accordion.Body>
                               Firmly established by a deeply rooted history and strong leadership, Wills Eye is focused on providing world-class eye care to patients around the globe, driven by the need to protect sight and further our ever-growing efforts to advance eye research. Wills Eye has long been recognized for numerous achievements in ophthalmology. We are honored to have been named at the top of U.S. News & World Report's "Best Hospitals" every year since the survey began and annually recognized in Philadelphia magazine's "Top Doctors."
                            </Accordion.Body>
                        </Accordion.Item>
